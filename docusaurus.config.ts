...
const config: Config = {
  ...
  url: 'https://courses.routerprotocol.com',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/ShivankK26/Router-Academy-Courses',
        },
        theme: {
  ...
  themeConfig: {
    ...
    //         {
    //           label: 'Twitter',
    //           href: 'https://twitter.com/SuperRabbbitsDAO',
    //         },
    //       ],
    //     },
    //     {
    ...
    //     },
    //   ],
    //   copyright: `Copyright © ${new Date().getFullYear()} Router Protocol.`,
    // },
    prism: {
